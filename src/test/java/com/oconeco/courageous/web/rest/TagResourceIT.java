...
import static com.oconeco.courageous.domain.TagAsserts.*;
...
class TagResourceIT {
    ...
    private static final Boolean DEFAULT_DEFAULT_TAG = false;
    private static final Boolean UPDATED_DEFAULT_TAG = true;
    ...
    void getAllTags() throws Exception {
        ...
        restTagMockMvc
            ...
            .andExpect(jsonPath("$.[*].defaultTag").value(hasItem(DEFAULT_DEFAULT_TAG.booleanValue())))
    ...
    void getTag() throws Exception {
        ...
        restTagMockMvc
            ...
            .andExpect(jsonPath("$.defaultTag").value(DEFAULT_DEFAULT_TAG.booleanValue()))
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.label(UPDATED_LABEL).dateCreated(UPDATED_DATE_CREATED).lastUpdated(UPDATED_LAST_UPDATED);
