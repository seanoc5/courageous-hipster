...
import { deleteEntity, getEntity } from './context.reducer';
...
export const ContextDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="courageousSearchApp.context.delete.question">Are you sure you want to delete Context {contextEntity.id}?</ModalBody>
      <ModalFooter>
