...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THINGTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_THINGTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_THINGTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_THINGTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_THINGTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_THINGTYPE actions', async () => {
      const arg = 42666;
