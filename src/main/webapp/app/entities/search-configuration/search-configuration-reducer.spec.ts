...
import reducer, {
  ...
  reset,
  updateEntity,
} from './search-configuration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHCONFIGURATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEARCHCONFIGURATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SEARCHCONFIGURATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SEARCHCONFIGURATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SEARCHCONFIGURATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SEARCHCONFIGURATION actions', async () => {
      const arg = 42666;
