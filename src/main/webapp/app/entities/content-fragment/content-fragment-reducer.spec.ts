...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENTFRAGMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTENTFRAGMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTENTFRAGMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONTENTFRAGMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTENTFRAGMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTENTFRAGMENT actions', async () => {
      const arg = 42666;
