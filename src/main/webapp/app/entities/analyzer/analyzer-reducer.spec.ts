...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './analyzer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANALYZER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ANALYZER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ANALYZER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ANALYZER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ANALYZER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ANALYZER actions', async () => {
      const arg = 42666;
