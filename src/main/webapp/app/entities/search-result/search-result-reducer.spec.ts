...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHRESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEARCHRESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SEARCHRESULT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SEARCHRESULT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SEARCHRESULT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SEARCHRESULT actions', async () => {
      const arg = 42666;
